...
import java.util.Objects;
    ...
    public class Coder implements Serializable {
        ...
        public boolean equals(Object o) {
            ...
            Coder coder = (Coder) o;
            return Objects.equals(id, coder.id) && Objects.equals(nombre, coder.nombre) && Objects.equals(apellidos, coder.apellidos) && Objects.equals(edad, coder.edad) && Objects.equals(pais_origen, coder.pais_origen) && Objects.equals(estudios, coder.estudios) && Objects.equals(direccion, coder.direccion) && Objects.equals(promocion, coder.promocion);
        }

        @Override
        public int hashCode() {
        return Objects.hash(id, nombre, apellidos, edad, pais_origen, estudios, direccion, promocion);
        }
